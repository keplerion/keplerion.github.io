class superformulaobj(){
   ...
   constructor(){
	...
	this.lineWidth = 1;
	this.color = '#000';
	this.selected_color = '#F00';
	this.numberOfPoints = 45;
	this.minX = 0, maxX = 0, minY = 0, maxY = 0;
	this.select = false;
	this.name;
	this.offsetX = 0,offsetY = 0, oldoffsetX = 0, oldoffsetY = 0;
	this.oldCoordX, oldCoordY;
	this.f2d_links = [];
	this.scale = 1;
	this.anim_path = [];
    ...
    renderFormula(m,n1,n2,n3,a,b,i,x,y) {
      this.m = m;
      this.n1 = n1;
      this.n2 = n2;
      this.n3 = n3;
